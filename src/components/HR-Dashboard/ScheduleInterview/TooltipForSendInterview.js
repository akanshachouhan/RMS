...
import { firstTechnicalRoundHandler} from '../../../api/api.js';
...
//   const userEmail = JSON.parse(localStorage.getItem('userData')).emailid;
    ...
    const sendEmail = (event) => {
      ...
      emailid: props.props.emailid,
        ...
        firstTechnicalRoundHandler(scheduleTestData)
        setAddedJobs(true);
      }
    ...
    return (
        <div>
            <Tooltip title="Schedule Technical Interview">
          ...
          {/* <Box>
            ...
            <Box sx={{ textAlign: 'center', m: 1, fontWeight: 'bold' }}>Send Next Technical Interview Link to {props.props.firstName} {props.props.lastName}</Box>
