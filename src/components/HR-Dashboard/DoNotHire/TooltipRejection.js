...
import {   sendRejectedMail} from '../../../api/api.js';
...
//   const userEmail = JSON.parse(localStorage.getItem('userData')).emailid;
    ...
    const sendEmail = (event) => {
      ...
      emailid: props.props.emailid,
        ...
        sendRejectedMail(scheduleTestData)
        setAddedJobs(true)
      }
    ...
    return (
        <div>
            <Tooltip title="Send Rejection Mail">
          ...
          {/* <Box>
            ...
            <Box sx={{ textAlign: 'center', m: 1, fontWeight: 'bold' }}>Send Rejection Mail to {props.props.firstName} {props.props.lastName}</Box>
