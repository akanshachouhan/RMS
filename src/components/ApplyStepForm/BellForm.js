...
import BellAddMoreExperience from "./BellAddMoreExperience";
import NumberFormat from "react-number-format";
import BellAddMoreProjects from "./BellAddMoreProjects";
...
export default function BellForm() {
  const intialValues = {
    firstName: "",
    emailId: "",
    contactNumber: "",
  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        <Box>
          <Accordion sx={{ width: "100%", paddingBottom: "1%" }}>
            <Box
              sx={{
                width: "100%",
                background: "#1976D2",
            ...
            <ImgUpload/>
            <label style={{marginTop:"15px",marginBottom:"15px",background:"#E8F0FE",fontSize: "0.9rem", fontWeight: "bold" ,color:"Black",marginLeft:"2%"}}>Personal Information Details : <span style={{color:"red"}}>" Please Fill All The Informations ! "</span></label>
              <Grid container spacing={3} sx={{  pl: 1, pr: 1 }}>
                <Grid item lg={3}>
                  {" "}
                  <div>
                    <label style={{fontSize: "0.9rem", fontWeight: "bold" ,color:"gray"}}>Full Name *</label>
                    <input
                ...
                <Grid item lg={3} xs={12}>
                  <div>
                    {" "}
                    <label style={{fontSize: "0.9rem", fontWeight: "bold" ,color:"gray"}}>Email Id *</label>
                    <input
                      sx={{ fontSize: "0.8rem", fontWeight: "bold" }}
                      id="emailId"
                      name="emailId"
                ...
                <Grid item lg={3} xs={12}>
                  <div>
                    <div>
                      {" "}
                      <label style={{fontSize: "0.9rem", fontWeight: "bold" ,color:"gray"}}>Contact Number *</label>
                      <input
                        sx={{ fontSize: "0.8rem", fontWeight: "bold" }}
                        id="contactNumber"
                        name="contactNumber"
                ...
                <Grid item lg={3} xs={12}>
                  <label style={{fontSize: "0.9rem", fontWeight: "bold" ,color:"gray"}}>Gender *</label>
                ...
                <Grid item lg={3} xs={12}>
                  <label style={{fontSize: "0.9rem", fontWeight: "bold" ,color:"gray"}}>Country *</label>
                  ...
                  <Grid item lg={3} xs={12}>
          <div>       
        <label style={{fontSize: "0.9rem", fontWeight: "bold" ,color:"gray"}}>State *</label>
        <br></br>
        ...
        <Grid item lg={3} xs={12}>
        <div>       
        <label style={{fontSize: "0.9rem", fontWeight: "bold" ,color:"gray"}}>City *</label >
        <br></br>
        ...
        <Grid item lg={3}>
                  {" "}
                  <div>
                    <label style={{fontSize: "0.9rem", fontWeight: "bold" ,color:"gray"}}>Address *</label>
                    <input
                      sx={{ fontSize: "0.8rem", fontWeight: "bold" }}
                      id="address"
                      name="address"
